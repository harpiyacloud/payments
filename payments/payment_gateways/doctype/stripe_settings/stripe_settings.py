...
from harpiya.integrations.utils import create_request_log, make_get_request
from harpiya.model.document import Document
from harpiya.utils import call_hook_method, cint, flt, get_url
	...
	def validate_stripe_credentails(self):
		if self.publishable_key and self.secret_key:
			...
			try:
				...
				harpiya.throw(_("Seems Publishable Key or Secret Key is wrong !!!"))
	...
	def create_charge_on_stripe(self):
		...
		try:
			...
			if charge.captured == True:
				...
				harpiya.log_error(charge.failure_message, "Stripe Payment not completed")
...
def get_gateway_controller(doctype, docname):
	reference_doc = harpiya.get_doc(doctype, docname)
